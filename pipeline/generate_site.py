...
<rect x="10" y="40" width="44" height="8" rx="4" fill="#2563eb"/>
...
:root {
  ...
  --navy:#0f3d2e; --navy-2:#155e3f; --accent:#2563eb; --accent-dark:#1d4ed8;
...
.hero { background:linear-gradient(120deg, var(--navy) 0%, var(--navy-2) 70%, #1e7a52 100%);
  color:#fff; margin:0 -1rem; }
.hero-inner { max-width:960px; margin:0 auto; padding:2.2rem 1rem 2.4rem; }
.hero-kicker { color:#7fb8ff; font-weight:700; font-size:.85rem; margin:0 0 .4rem; }
